...
function FilesView() {
    ...
    return (
        <div
            className="flex select-none flex-col gap-1 px-4 py-4"
            style={{ height: viewHeight, maxHeight: viewHeight }}
        >
            <h2 className="mb-3 text-sm font-medium uppercase tracking-wider text-slate-400">Files</h2>
            <FileStructureView />
            <div
                className={cn(`flex min-h-fit flex-col justify-end gap-2 border-t border-slate-800 pt-4 mt-4`, {
                    hidden: minHeightReached,
                })}
            >
                <button
                    className="flex w-full items-center justify-start gap-2 rounded-lg border border-slate-800 bg-slate-900/50 px-3 py-2.5 text-sm text-slate-300 transition-colors hover:border-slate-700 hover:bg-slate-800 disabled:opacity-50"
                ...
                <button
                    className="flex w-full items-center justify-start gap-2 rounded-lg border border-slate-800 bg-slate-900/50 px-3 py-2.5 text-sm text-slate-300 transition-colors hover:border-slate-700 hover:bg-slate-800"
                    onClick={downloadFilesAndFolders}
                >
                    <BiArchiveIn size={18} /> Download Code
                </button>
            </div>
        </div>
    )
